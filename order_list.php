...
if(isset($_SESSION['is_loged']) && $_SESSION['is_loged'])
{
	if(!empty($_POST) && $_POST['order'] =='order')
	{
		...
		$order->bindValue(':ord_products', $_SESSION['panier'], PDO::PARAM_ARRAY);
				...
				<table class="table table-striped">
					...
					<?php
						...
						else
						{
							...
							echo '<a href="order_list.php"><input type="submit" class="btn btn-primary text-right"><input type="hidden" name="order" value="order" ></a>';
